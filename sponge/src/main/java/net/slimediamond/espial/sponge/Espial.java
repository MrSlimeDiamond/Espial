...
public class Espial {
    ...
    public void onRegisterBuilders(final RegisterBuilderEvent event) {
        ...
        event.register(ContainerChangeRecord.Builder.class, SpongeContainerChangeRecordBuilder::new);
        event.register(ItemFrameChangeRecord.Builder.class, SpongeItemFrameChangeRecordBuilder::new);
