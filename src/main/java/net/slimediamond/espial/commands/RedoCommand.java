...
//        HashMap<Object, ArrayList<EspialTransaction>> transactions = Espial.getInstance().getEspialService().getTransactions();
//
...
//                }
//
//                context.sendMessage(Espial.prefix.append(Component.text(transaction.getIds().size()).append(Component.text(" action(s) have been redone.")).color(NamedTextColor.WHITE)));
//                return CommandResult.success();
//            }
//
//            context.sendMessage(Espial.prefix.append(Component.text("There is nothing to redo.").color(NamedTextColor.WHITE)));
