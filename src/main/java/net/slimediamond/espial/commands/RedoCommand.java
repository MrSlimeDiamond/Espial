    ...
    public CommandResult execute(CommandContext context) throws CommandException {
        ...
        if (!transactions.containsKey(context.cause().root())) {
            ...
            while (iterator.hasPrevious()) {
                ...
                context.sendMessage(Espial.prefix.append(Component.text(transaction.getAffectedIds().size()).append(Component.text(" action(s) have been redone.")).color(NamedTextColor.WHITE)));
                return CommandResult.success();
            }
