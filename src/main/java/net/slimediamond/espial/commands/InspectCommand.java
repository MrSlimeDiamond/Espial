        ...
        try {
            ...
            PaginationList.builder()
                    ...
                    .contents(Component.text()
                            .append(Format.chip(Component.text("STOP", NamedTextColor.RED), Component.text("Stop inspection particles"))
                                    .clickEvent(ClickEvent.runCommand("/espial inspect stop")))
                            .append(Format.chip(Component.text("TP", NamedTextColor.GREEN), Component.text("Teleport to this block"))
                                    .clickEvent(SpongeComponents.executeCallback(cause -> this.teleportPlayer(player, record.getAction()))))
                            .append(Format.chip(Component.text(undoActionMessage, NamedTextColor.YELLOW), Component.text("Undo this action"))
